namespace DotnetPostprocessing.Post
{
    ...
    public partial class Postprocessor: TPostprocessor
    {
        ...
        public override void OnLocalCS(ICLDOriginCommand cmd, CLDArray cld)
        {
            ...
            } else { // Local CS activation (CYCLE800)
                nc.Block.Out();

                int v_Dir = 0; // Stay
                if (cmd.PositioningMode > CLDOriginPositionMode.Stay) { // Turn, Move
        ...
        {
            if (!Cycle.CycleOn || Cycle.Cycle_pocket) {  // Drugoj vyvod dlya sverlilnyx cziklov poziczij otverstij
        ...
        public override void OnHoleExtCycle(ICLDExtCycleCommand cmd, CLDArray cld)
        {
            ...
            if (cmd.IsOn) {
                ...
                if (cmd.CycleType == 491){// Dlya karmanov POCKET
                    Cycle.OutCycle(CycleName+Str(CycleNumber), CycleGeomName);
                    nc.GInterp.v0 = double.MaxValue;
                }else { // Vyvod czikla MCALL dlya gruppy otverstij
            ...
            if (cmd.IsOff && cmd.CycleType != 491) {//Vyklyuchenie czikla
